...
const AdminAppInvoice = ({appointment, appDetail}) => {
    ...
    const InvoiceTitle = () => (
      <View style={styles.titleContainer}>
          <View style={styles.spaceBetween}>
              <Image style={styles.logo} src="/broken-pipe.png"/>
              <Text style={styles.reportTitle}>Broken Pipe Plumbing</Text>
          </View>
      </View>
    );
    ...
    const Address = () => (
      <View style={styles.titleContainer}>
          <View style={styles.spaceBetween}>
              ...
              <View>
                  <Text style={styles.addressTitle}>13729 N Central Expy, </Text>
                  <Text style={styles.addressTitle}>Dallas, TX 75243</Text>
              </View>
          </View>
      </View>
    );
...
export default AdminAppInvoice;